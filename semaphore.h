...
//***implemented in semaphore.cpp***
//***used in the boundedbuf.cpp***
...
public:// ***Here are all the different things you can do with the semaphore object.***
	...
	SEMAPHORE(int size);//***constructor***
	...
	int P(int semname);//***exactly the same thing as defined in lecture***

	// semaphore V operation on semaphore semname
	// precondition: existence of SEMAPHORE object
	// postcondition: semaphore increments and process may be resumed
	// return value: -1 denotes an error
	int V(int semname);//***exactly the same thing as defined in lecture***
};
